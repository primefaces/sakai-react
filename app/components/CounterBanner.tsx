...
export default function CounterBanner({statisticValue}: {statisticValue: MainPageStatistics | null}) {
    ...
    return (
        <div className="w-full h-[300px] relative my-[50px] sm:my-[30px] -z-50">
            <div className="absolute left-1/2 top-0 w-screen -translate-x-1/2 grid sm:grid-cols-2 justify-between lg:grid-cols-4 gap-4 bg-[var(--titleColor)] p-[40px] lg:p-[80px] text-white">
