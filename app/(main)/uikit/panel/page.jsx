...
const PanelDemo = () => {
  ...
  const toolbarRightTemplate = (
    <SplitButton label='Options' icon='pi pi-check' model={toolbarItems} menuStyle={{ width: '12rem' }}></SplitButton>
  )
  const cardHeader = (
          ...
          <div className='grid'>
            ...
            <div className='col-5 align-items-center justify-content-center'>
              ...
              <p>
                ...
                repellat. Donec vel volutpat ipsum. Integer nunc magna, posuere ut tincidunt eget, egestas vitae sapien.
