      ...
      <div className='grid'>
        <div className='col-12'>
          <div className='card docs'>
            ...
            <p>
              Next step is running the application using the start script and navigate to <b>http://localhost:3000/</b>{' '}
              to view the application. That is it, you may now start with the development of your application using the
              Sakai template.
            </p>
...
`}</code>
            ...
            <p>
              ...
              under the app folder; <span className='text-primary font-medium'>{`(main)`}</span> represents the pages
              that reside in the main dashboard layout whereas{' '}
              <span className='text-primary font-medium'>{`(full-page)`}</span> groups the pages with full page content
            ...
            <p>
              ...
              <span className='text-primary font-medium'>app/layout.jsx</span> file. It contains the style imports and
        ...
        <PrimeReactProvider>
          <LayoutProvider>{children}</LayoutProvider>
            ...
            <p>
              ...
              <span className='text-primary font-medium'>app/{'(main)'}/layout.jsx</span> as the root layout.
            </p>
            <pre className='app-code'>
              <code>
...
export default function AppLayout({ children }) {
  return <Layout>{children}</Layout>
            ...
            <p>
              ...
              <span className='text-primary font-medium'>app/{'(full-page)'}/layout.jsx</span> as the root layout.
            </p>
            <pre className='app-code'>
              <code>
    ...
    <React.Fragment>
      ...
      <AppConfig simple />
            ...
            <p>
              ...
              <span className='text-primary font-medium'>layout/context/layoutcontext.jsx</span> file, this step is
              optional and only necessary when customizing the defaults.
            </p>
...
export const LayoutProvider = (props) => {
  const [layoutConfig, setLayoutConfig] = useState({
      ...
      scale: 14                               // size of the body font size to scale the whole application
            ...
            <p>
              Only the folders related to the layout need to be moved into your project. Integration of pages involves
              moving the files under those folders. Make sure that the using page is defined under the related group
              layout.
            </p>
            ...
            <p>
              In case you&apos;d like to customize the main layout variables, open <b>_variables.scss</b> file under
              layout folder. Saving the changes will be reflected instantly at your browser.
            </p>
