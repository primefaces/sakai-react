    ...
    return (
        <div>
            {skeleton ? (
                        ...
                        <>
                        {/* info section */}
                            <InfoBanner title="Угуучулардын тизмеси" titleSize={{ default: '20px', sm: '30px' }} />
                        </>
                    ) }
                    ...
                    {skeleton ? (
                        ...
                        <>
                            <DataTable value={studentList} dataKey="id" breakpoint="960px" rows={5} className="mini-table">
                                ...
                                <Column field="title" header="ФАА" style={{ width: '50%' }} body={(rowData) => <div className='flex gap-1'>
