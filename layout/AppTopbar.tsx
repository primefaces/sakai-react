    ...
    return (
        <div className="layout-topbar">
            <Link href="/" className="layout-topbar-logo">
                ...
                <h3 className="hidden sm:block text-[18px] md:text-[30px]">{translations.digitalCampusOshSU}</h3>
            </Link>
                    ...
                    {skeleton ? (
                        ...
                        <div className={`hidden lg:block ${media ? 'order-1' : 'order-2'}`}>
                            <Link href={'/auth/login'}>
                                <FancyLinkBtn btnWidth={'100px'} backround={'--redColor'} effectBg={'--mainColor'} title={translations.login} btnType={false} />
                            </Link>
                        </div>
                    )}
                </div>
