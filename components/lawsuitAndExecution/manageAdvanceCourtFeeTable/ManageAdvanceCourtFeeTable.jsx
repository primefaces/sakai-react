  ...
  return (
    <div>
      ...
      >
        ...
        <Column field='phu_trach_2' header='Số tiền đóng TƯAP' style={{ minWidth: '12rem' }} />
        <Column field='phu_trach_2' header='Số tiền hoàn TƯAP' style={{ minWidth: '12rem' }} />
        <Column field='phu_trach_2' header='Ngày hoàn TƯAP' style={{ minWidth: '12rem' }} />
        <Column field='phu_trach_2' header='Biên lai' style={{ minWidth: '10rem' }} />
      </DataTable>
    </div>
  )
}
