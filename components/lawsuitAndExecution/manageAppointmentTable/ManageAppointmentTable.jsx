  ...
  return (
    <div>
      ...
      >
        ...
        <Column field='phu_trach_2' header='Ngày hẹn' style={{ minWidth: '7rem' }} />
        <Column field='phu_trach_2' header='Nội dung' style={{ minWidth: '15rem' }} />
        <Column field='phu_trach_2' header='Nhân viên thực hiện' style={{ minWidth: '12rem' }} />
        <Column field='phu_trach_2' header='Thời gian cập nhật' style={{ minWidth: '12rem' }} />
      </DataTable>
    </div>
  )
}
