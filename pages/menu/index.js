...
import { PersonalDemo } from "../../src/components/menu/PersonalDemo";
import { ConfirmationDemo } from "../../src/components/menu/ConfirmationDemo";
import { PaymentDemo } from "../../src/components/menu/PaymentDemo";
import { SeatDemo } from "../../src/components/menu/SeatDemo";
...
const MenuDemo = () => {
    ...
    const wizardItems = [
        { label: "Personal", command: () => console.log("/menu") },
        { label: "Seat", command: () => console.log("/menu/seat") },
        { label: "Payment", command: () => console.log("/menu/payment") },
        { label: "Confirmation", command: () => console.log("/menu/confirmation") },
    ];
        ...
        <div className="grid p-fluid">
            ...
            <div className="col-12 md:col-6">
                <div className="card card-w-title">
                    ...
                    {activeIndex === 0 ? <PersonalDemo /> : activeIndex === 1 ? <ConfirmationDemo /> : activeIndex === 2 ? <PaymentDemo /> : activeIndex === 3 ? <SeatDemo /> : null}
                </div>
            </div>
