      ...
      <div className="grid">
        <div className="col-12">
          <div className="card docs">
            ...
            <p>
              Bersii is an application template for React based on the popular{" "}
              <a
            ...
            <p>
              ...
              application using the Bersii template.
            </p>
            ...
            <h5>Dependencies</h5>
            <p>
              Dependencies of Bersii are listed below and needs to be defined at
              package.json.
            </p>
...
`}</code>
            ...
            <h5>Structure</h5>
            <p>
              Bersii consist of a couple of folders where demos and core layout
              have been separated.
            </p>
...
export const LayoutProvider = (props) => {
    const [layoutConfig, setLayoutConfig] = useState({
        ...
        scale: 14                               //size of the body font size to scale the whole application
            ...
            <p>
              Bersii theming is based on the PrimeReact theme being used.
              Default theme is <b>lara-light-indigo</b>.
            </p>
